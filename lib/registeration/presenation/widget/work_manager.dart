...
//       if (role == 'user') {
//
//         batch.set(FirebaseFirestore.instance.collection('admins').doc( FirebaseAuth.instance.currentUser?.uid).collection('dates').doc('${DateTime.now().month.toString()}-${DateTime.now().year.toString()}'),
//             {
//               'setFlag': true
//             },
//             SetOptions(merge: true));
//         batch.update(FirebaseFirestore.instance.collection('admins').doc( FirebaseAuth.instance.currentUser?.uid).collection('dates').doc('${DateTime.now().month.toString()}-${DateTime.now().year.toString()}'), {
//           'numberOfNewMembers': FieldValue.increment(1)
//           //add 1 to as int
//         },
//         );
