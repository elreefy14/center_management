      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(4.0),
            borderSide:
                BorderSide(color: const Color(0xFF2196F3), width: 1.5.w),
          ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context!).showSnackBar(
                        const SnackBar(
                            content: Text('تم نسخ كلمة المرور إلى الحافظة')),
                      );
                    },
                    style: ButtonStyle(
                  ...
                  ? IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (await Permission.contacts.request().isGranted) {
                          ...
                          // print('Pressed');
                          // Removed Contact code that was causing errors
...
Widget pickContactButton({
  ...
  return TextButton.icon(
    ...
    onPressed: () async {
      if (await Permission.contacts.request().isGranted) {
        // Contact picker functionality removed
        // We can replace with a simple dialog message
        ...
        showDialog(
          ...
          builder: (dialogContext) => AlertDialog(
            ...
            content: const Text(
                'Contact picking feature has been removed from this version.'),
            actions: [
              TextButton(
